...
import { IconButton, ListItem, useMediaQuery } from "@mui/material";
...
const themedStyles = (theme: Theme, responsiveDrawerWidth: number | string) => {
  return {
    ...
    content: {
      marginLeft: responsiveDrawerWidth === "100%" ? 0 : responsiveDrawerWidth,
      padding: 3,
      maxWidth: 720,
      minWidth: 375,
      ...
      <div>
        ...
        >
          <Toolbar>
            ...
            <Typography noWrap>Advanced Material UI Styling</Typography>
          </Toolbar>
        </AppBar>
        <Drawer
          disableEnforceFocus
